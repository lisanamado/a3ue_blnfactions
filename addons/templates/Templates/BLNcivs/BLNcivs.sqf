...
//Check if they are spawned in several colours or just one for each.
...
["vehiclesCivCar", [
    ...
    ,  "C_Quadbike_01_F", 0.2
    , "CUP_C_Ikarus_Chernarus", 0.1
    , "C_Kart_01_F", 0.1
    , "C_Offroad_01_F", 0.2
    , "a3a_Offroad_01_comms_tan_F", 0.1
    , "a3u_cup_uaz_unarmed_convertible_1", 0.3
...
["vehiclesCivIndustrial", [
    ...
    , "a3a_Van_02_black_service_F", 0.1
    , "C_Van_01_box_F", 0.2
